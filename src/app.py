...
print(f"[+] Url database connection {connection_string}")
...
engine.execute(""" CREATE TABLE IF NOT EXISTS publishers  (
...
-- book authors
INSERT INTO book_authors (book_id, author_id) VALUES (1, 1) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (2, 8) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (3, 7) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (4, 6) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (5, 5) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (6, 4) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (7, 3) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (8, 2) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (9, 4) ON CONFLICT (book_id, author_id) DO NOTHING;
INSERT INTO book_authors (book_id, author_id) VALUES (10, 1) ON CONFLICT (book_id, author_id) DO NOTHING;   """)


# 4) Use pandas to print one of the tables as dataframes using read_sql function
dataframe = pd.read_sql("Select * from books;", engine)
print(f"From Books table\n{dataframe.describe()}\n")
dataframe = pd.read_sql("Select * from publishers;", engine)
print(f"From Publishers table\n{dataframe.describe()}\n")
dataframe = pd.read_sql("Select * from authors;", engine)
print(f"From Authors table\n{dataframe.describe()}\n")
